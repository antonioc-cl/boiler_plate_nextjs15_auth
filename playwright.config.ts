...
export default defineConfig({
  ...
  webServer: {
    ...
    env: {
      ...
      BETTER_AUTH_SECRET: process.env.BETTER_AUTH_SECRET || "test-secret-for-e2e-tests-123456789",
      ...
      PLUNK_REPLY_TO_EMAIL: process.env.PLUNK_REPLY_TO_EMAIL || "test@example.com",
